...
angular
  ...
  .factory('CommonUtil', [
    '$location', function ($location) {
      ...
      CommonUtil.TWEET_TOKEN = "AAAAAAAAAAAAAAAAAAAAANQyvQAAAAAATD73RCSSU3W8wSPAc0CGcfLk%2BQE%3D1sK3m7uiqQsdL06pMumW4adtZSRiYpSjMUqNzQia6JTLTR5QHw";
      ...
      CommonUtil.formatDateTime2 = function(datetimeStr) {
        if(datetimeStr == "" || datetimeStr == null || typeof datetimeStr == 'undefined')
          return moment.unix(Date.now()/1000).format("YYYY-MM-DD HH:mm");

        if(typeof datetimeStr == 'string')
          return datetimeStr;
        else
          return moment.unix(datetimeStr.getTime()/1000).format("YYYY-MM-DD HH:mm");
      };
      ...
      CommonUtil.getFullName2 = function(user) {
        ...
        if(user.lastName) temp.push(user.lastName);
        if(user.firstName) temp.push(user.firstName);
      ...
      CommonUtil.getRoleName = function(role) {
        switch (role) {
      ...
      CommonUtil.getSubscriptionTypeName = function(subscriptionType) {
        switch(subscriptionType) {
          case 0: return "Free Trial";
          case 1: return "No Subscription";
          case 2: return "Weekly Subscription";
          case 3: return "Monthly Subscription";
      ...
      CommonUtil.roleList = [0, 1, 2, 3, 4, 5, 6];
      CommonUtil.planList = [0, 1, 2, 3, 4, 5, 6];
      ...
      CommonUtil.variableTypes = [
        {name:'Short Text', fieldType:'text', format:function(value){return value;}},
        {name:'Long Text', fieldType:'textarea', format:function(value){return value;}},
        {name:'Integer', fieldType:'text', format:function(value){return parseInt(value);}},
        {name:'Decimals', fieldType:'text', format:function(value){return parseFloat(value);}},
        {name:'File', fieldType:'file', format:function(value){return value;}},
        {name:'JSON', fieldType:'json',
          format:function(value){ return value;},
          validate:CommonUtil.jsonValidate
        },
      ];
