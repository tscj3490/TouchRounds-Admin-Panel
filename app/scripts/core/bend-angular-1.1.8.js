...
(function() {
  ...
  var bendFn = function() {
    ...
    //Bend.API_ENDPOINT = 'https://api.touchrounds.com';
    ...
    Bend.setActiveUser = function(user) {
      ...
      if(null != user) { // Save the active user.
        ...
        /* BEGIN */
        //Storage.save('tokenLastUsedTime', Date.now().valueOf()); //polarislee, 2016/5/31
        /* END */
      }
    ...
    Bend.Group.count2 = function(field, field2) {
      // Return the aggregation.
      var agg = new Bend.Group();
